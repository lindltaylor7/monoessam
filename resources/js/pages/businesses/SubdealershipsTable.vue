...
<template>
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-md transition-all duration-200 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            >
                <div>
                    <h3 class="font-medium text-gray-900 dark:text-white">
                        {{ subdealership.name }}
                        <span class="ml-2 rounded-full bg-purple-100 px-2 py-0.5 text-xs font-medium text-purple-800 dark:bg-purple-900 dark:text-purple-200">
                            Subconcesionaria
                        </span>
                    </h3>
            ...
            <div v-if="props.subdealerships.length === 0" class="p-6 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No hay subconcesionarias registradas</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Agrega la primera subconcesionaria para comenzar</p>
            </div>
        </div>
    </div>
</template>
