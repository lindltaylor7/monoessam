    ...
    <div class="space-y-4">
        ...
        <div v-if="selectedStaffIds.length > 0" class="bg-muted/50 mb-4 flex items-center justify-between rounded-lg border p-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <Button variant="outline" size="sm" @click="selectedStaffIds = []" class="text-gray-500"> Cancelar </Button>
            </div>
        </div>
                    ...
                    >
                        <td class="p-4">
                            <Checkbox
                                ...
                                @update:model-value="(val: any) => toggleSelectStaff(staff.id, !!val)"
                            />
                        </td>
                        ...
                        <td class="p-4">
                            <StatusBadge :label="getStatusLabel(staff.status)" :color-class="getStatusColor(staff.status)" @click="onChangeStatus" />
                        </td>
